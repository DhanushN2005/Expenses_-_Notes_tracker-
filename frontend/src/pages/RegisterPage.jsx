...
import { UserPlus, User, Mail, Lock, Eye, EyeOff, AlertTriangle } from 'lucide-react';
      ...
      <div className="w-full max-w-md transform transition-all duration-300">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Create a secure, free personal account to start organizing
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <input
                  ...
                  className="block w-full rounded-2xl border border-slate-800 bg-slate-950 py-3 pl-11 pr-4 text-sm text-slate-100 placeholder-slate-500 shadow-inner outline-none transition-all duration-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <input
                  ...
                  className="block w-full rounded-2xl border border-slate-800 bg-slate-950 py-3 pl-11 pr-12 text-sm text-slate-100 placeholder-slate-500 shadow-inner outline-none transition-all duration-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
